...
* Supported format are ccd/sub/img iso (trurip), and single file MODE1/2352 bin/cue (use utilities like "daemon tools lite" + "imgburn" to convert your iso if needed)
